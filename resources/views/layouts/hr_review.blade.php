...
<?php $page_navigation_no='hr_review'; ?>
...
<?php try{ ?>
    <div class="table-section" id="hr_details">
		<div class="container-fluid" style="margin-bottom: 10px;margin-top: 20px;">
			<div class="row">
				...
				<div class="col-md-5">
					<input type='hidden' id="fin_path" value='hr_review'/>
					<?php
				...
				<div class="col-md-12 is-tab-content">
					<ul class="nav nav-tabs am-menu" style="margin-bottom:10px;">
						<li class="active nav-item">
							<a class="nav-link" data-toggle="tab" href="#hr_review_tocheck">To check</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#hr_review_checked">Checked</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="row col-md-2" style="float:right">
				<input id="hr_review_table_filter" class="dataTables_custom_filter" placeholder="Search" class="form-control">
			</div>
		</div>
		<div class="container-fluid table-content">
			<div class="row tab-content travel-request-table">
				<div id="hr_review_tocheck" class="col-md-12 tab-pane active">
					<table id="hr_review_tocheck_table">
						<thead>
							<tr>	
								<th>Request id</th>
								<th>Request type</th>
						...
						<tbody>	
							@foreach($hr_review_tocheck as $requests)
							<tr>
								<td>
								<a href="/visa_request/{{Crypt::encrypt($requests->id)}}">
								...
								<td>								
									<a href="/visa_request/{{Crypt::encrypt($requests->id)}}"><img src="/images/action.svg" class="action_image" data-toggle="tooltip" title="Review"></a>
								</td>
							</tr>
							@endforeach	
						</tbody>	
				...
				<div id="hr_review_checked" class="col-md-12 tab-pane fade">
					<table id="hr_review_checked_table">
						<thead>
							<tr>	
						...
						<tbody>	
						@foreach($hr_review_checked as $requests)
							<tr>
								<td>
								<a href="/visa_request/{{Crypt::encrypt($requests->id)}}">
								<img src="/images/status/{{$icons[$requests->status_id]}}" class="status_img " title="{{$requests->status_name}}" data-toggle="tooltip">
