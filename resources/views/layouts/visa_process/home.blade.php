...
@php $page_navigation_no="visa_process_home"; $tab_navigation="us_visa_process";@endphp
...
<div class="container-fluid visa_process_container">
    <div class="tab-content table-tab-content">
        <div class="card requestdetail">
            <div class="row">
                <div class='col-md-2 col-sm-12  col-xs-12 card-header'><h3>My Requests</h3></div>
                <div class="col-md-2 col-sm-12 col-xs-12 new-request-button">
                    <a type="button" class="main-button" href="/visa_process/request"><img src="/images/new-request.svg" style="margin-left: -20px;width: 35px;margin-right: 15px; ">&nbsp;&nbsp;New request</a>
                </div>
                <div class="col-md-2 col-sm-12 col-xs-12 search-bar-div">
                    <input type="text" name="search-bar-home-table" id="search-bar-home-table" placeholder="Search" class="form-control magnifier search-bar-home-table">
                </div>
            </div>
