...
@php $page_navigation_no="visa_process_hr_partner_review"; $tab_navigation="us_visa_process";@endphp
...
<div class="container-fluid visa_process_container">
    <div class="tab-content table-tab-content">
        <div class="card requestdetail">
            <div class="row">
                <div class='col-md-2 col-sm-12 col-xs-12 card-header'><h3>Visa process</h3></div>
