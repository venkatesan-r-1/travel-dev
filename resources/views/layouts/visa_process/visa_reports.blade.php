...
@section('content')
<?php  $page_navigation_no='visa_reports'; ?>
	...
	<div class="container-fluid" style="margin-bottom: 10px;margin-top: 20px;">
		<div class="row">
			...
			<div class="col-md-10">
				...
				<input id="visa_report_table_filter" class="dataTables_custom_filter" placeholder="Search" class="form-control" style="margin-left: 15px;">
				<input type='hidden' id="fin_path" value='visa_reports'/>
				<?php
			    ...
			    <div class="col-md-12">
                    <table id="visa_reports_table">
                        <thead>
							...
							<th style="display:none">Visa type</th>
							<th style="display:none">Visa category</th>
                            </tr>
                        </thead>
                        <tbody>	
                            ...
                            <tr>
							<td>
								<a href="/visa_request/{{Crypt::encrypt($requests->travel_request_id)}}">
								{{$requests->request_id}}
								</a>
							</td>
							...
							<td style="display:none">
								...
								<td style="display:none">{{$requests->visa_type_name}}</td>
								<td style="display:none">{{$requests->visa_category_name}}</td>
                            </tr>
                            @endforeach	
                        </tbody>
                    </table>
