...
<head>
    ...
    <div class="pdf">
        <div class="pdf-section">
            <p class="pdf-paragraph">
                ...
                <span class="pdf-paragraph-line" id="pdf-aceid">{{ $employee_value}}</span></b><br>
        ...
        <div class="pdf-section">
            ...
            <p class="pdf-paragraph">
                ...
                <span class="pdf-paragraph-line">Your compensation will be <b class="">USD {{$us_salary}} per annum</b> which will be paid in accordance with Aspire's pay schedule, subject to any legally permissible deductions.</span>
        ...
        <div class="pdf-section">
            <div class="pdf-paragraph">
                <span class="pdf-paragraph-line"><span class="pdf-text-bold">{{ $entity_id }}</span></span>
                <div class="pdf-digi-sign">
                    <img src="{{asset('images/signature.jpg')}}" alt="" width="200px" height="50px">
                </div>
                <span class="pdf-paragraph-line"><span class="pdf-text-bold">{{Auth::User()->user_name}}</span><br>{{Auth::User()->designation}} - Human Resources<br><a href="">tithee.paal@aspiresys.com</a></span>
            </div>
        </div>
        <div class="pdf-section">
            <div class="pdf-paragraph">
    ...
    <div class="doc" style="display:none;">
        ...
        <div class="word_document" id="doc_aceid">{{$employee_value}}</div>
        ...
        <div class="word_document" id="doc_entity">{{$entity_id}}</div>
        <div class="word_document" id="doc_us_hr">{{Auth::User()->user_name}}</div>
        <div class="word_document" id="doc_us_hr_designation">{{ Auth::User()->designation}}</div>
        <div class="word_document" id="doc_us_hr_department">Human Resources</div>
        <div class="word_document" id="doc_us_hr_mail">{{ Auth::User()->mail}}</div>
